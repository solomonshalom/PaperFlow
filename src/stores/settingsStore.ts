...
const settingUpdaters: {
  ...
  snippets: (value) => commands.updateSnippets(value as any[]),
  auto_format_enabled: (value) =>
    commands.changeAutoFormatEnabledSetting(value as boolean),
  auto_format_lists: (value) =>
    commands.changeAutoFormatListsSetting(value as boolean),
  verbal_commands_enabled: (value) =>
    commands.changeVerbalCommandsEnabledSetting(value as boolean),
  tone_adjustment_enabled: (value) =>
    commands.changeToneAdjustmentEnabledSetting(value as boolean),
  default_tone: (value) => commands.changeDefaultToneSetting(value as any),
  app_tone_mappings: (value) => commands.updateAppToneMappings(value as any),
  developer_mode: (value) => commands.changeDeveloperModeSetting(value as any),
  preserve_code_syntax: (value) =>
    commands.changePreserveCodeSyntaxSetting(value as boolean),
  developer_dictionary: (value) =>
    commands.updateDeveloperDictionary(value as string[]),
  correction_detection_enabled: (value) =>
    commands.changeCorrectionDetectionEnabledSetting(value as boolean),
  context_awareness_enabled: (value) =>
    commands.changeContextAwarenessEnabledSetting(value as boolean),
  context_per_app_permissions: (value) =>
    commands.updateContextPerAppPermissions(value as Record<string, boolean>),
  groq_transcription_api_key: (value) =>
    commands.changeGroqTranscriptionApiKeySetting(value as string),
  multilingual_mode_enabled: (value) =>
    commands.changeMultilingualModeEnabledSetting(value as boolean),
  primary_language: (value) =>
    commands.changePrimaryLanguageSetting(value as string | null),
  ...
  meeting_chunk_duration_seconds: (value) =>
    commands.changeMeetingChunkDurationSetting(value as number),
  meeting_auto_summarize: (value) =>
    commands.changeMeetingAutoSummarizeSetting(value as boolean),
  meeting_extract_action_items: (value) =>
    commands.changeMeetingExtractActionItemsSetting(value as boolean),
