...
export const Dropdown: React.FC<DropdownProps> = ({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        type="button"
        className={`px-2 py-1 text-sm font-semibold bg-mid-gray/10 border border-mid-gray/80 rounded w-[200px] text-left flex items-center justify-between transition-all duration-150 ${
          disabled
