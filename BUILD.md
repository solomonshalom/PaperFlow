...
This guide covers how to set up the development environment and build PaperFlow from source across different platforms.
...
```bash
git clone git@github.com:solomonshalom/PaperFlow.git
cd PaperFlow
```
