...
pub struct AppSettings {
    ...
    #[serde(default)]
    pub verbal_commands_enabled: bool,
    // === Context-Aware Tone ===
    #[serde(default)]
    pub tone_adjustment_enabled: bool,
    #[serde(default)]
    pub default_tone: ToneStyle,
    #[serde(default)]
    pub app_tone_mappings: HashMap<String, ToneStyle>,
    // === Developer Mode ===
    #[serde(default)]
    pub developer_mode: DeveloperMode,
    #[serde(default)]
    pub preserve_code_syntax: bool,
    #[serde(default)]
    pub developer_dictionary: Vec<String>,
    // === Corrections ===
    #[serde(default)]
    pub correction_detection_enabled: bool,
    // === Context Awareness (Privacy) ===
    #[serde(default)]
    pub context_awareness_enabled: bool,
    #[serde(default)]
    pub context_per_app_permissions: HashMap<String, bool>,
    // === Cloud Transcription ===
    #[serde(default)]
    pub groq_transcription_api_key: String,
    // === Multi-Language Mixing ===
    #[serde(default)]
    pub multilingual_mode_enabled: bool,
    #[serde(default)]
    pub primary_language: Option<String>,
    #[serde(default)]
    pub secondary_language: Option<String>,
    #[serde(default = "default_language_detection_sensitivity")]
    ...
    #[serde(default)]
    pub meeting_extract_action_items: bool,
...
fn default_language_detection_sensitivity() -> f32 {
    0.5
}

fn default_meeting_chunk_duration() -> u32 {
    30 // 30 seconds per chunk
}

fn default_meeting_summary_prompt() -> String {
    "Summarize the following meeting transcript in 3-5 bullet points, focusing on key decisions and discussion topics:\n\n${transcript}".to_string()
}
...
pub fn get_default_settings() -> AppSettings {
    ...
    // Meeting shortcut (platform-specific)
    #[cfg(target_os = "macos")]
    let meeting_shortcut = "option+shift+m";
    #[cfg(target_os = "windows")]
    let meeting_shortcut = "ctrl+shift+m";
    #[cfg(target_os = "linux")]
    let meeting_shortcut = "ctrl+shift+m";
    #[cfg(not(any(target_os = "windows", target_os = "macos", target_os = "linux")))]
    let meeting_shortcut = "alt+shift+m";
    ...
    bindings.insert(
        ...
        ShortcutBinding {
            ...
            description: "Toggle meeting recording on/off.".to_string(),
            default_binding: meeting_shortcut.to_string(),
            current_binding: meeting_shortcut.to_string(),
        },
    );
    ...
    AppSettings {
        ...
        verbal_commands_enabled: false,
        tone_adjustment_enabled: false,
        default_tone: ToneStyle::default(),
        app_tone_mappings: HashMap::new(),
        developer_mode: DeveloperMode::default(),
        preserve_code_syntax: false,
        developer_dictionary: Vec::new(),
        correction_detection_enabled: false,
        context_awareness_enabled: false,
        context_per_app_permissions: HashMap::new(),
        groq_transcription_api_key: String::new(),
        multilingual_mode_enabled: false,
